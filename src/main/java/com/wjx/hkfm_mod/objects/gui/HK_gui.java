...
public class HK_gui{
    ...
    public static class GuiMtInjector extends GuiContainer {
        ...
        public GuiMtInjector(InventoryPlayer player, HK_TileEntities.TileEntity_mt_b_injector tileentity) {
            super(new HK_Container.ContainerMtInjector(player,tileentity));
            this.player = player;
            this.tileentity = tileentity;
        }
        ...
        protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
            ...
            int l =this.getCookProgressScaled(24);
            this.drawTexturedModalRect(this.guiLeft + 54,this.guiTop + 39,176,1,l+1,16);
