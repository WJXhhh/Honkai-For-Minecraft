...
public class RenderFreezySickleDeader extends RenderLiving<EntityFreezySickleDeader> {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityFreezySickleDeader entity) {
        return TEXTURE;
    }

    @Override
    protected void applyRotations(EntityFreezySickleDeader entityLiving, float p_77043_2_, float rotationYaw, float partialTicks) {
